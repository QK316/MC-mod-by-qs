...
public class Blocks
{
    ...
    public static final RegistryObject<Block> REFINED_IRON_BLOCK = DEFERRED_REGISTER.register("refined_iron_block.json", ()-> new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.METAL).requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundType.METAL)));
